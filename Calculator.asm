...
LF		EQU		    10 
		...
		CALL		BDOS
AGAIN:		
		LXI 	    D, INTRO			;LOAD MESSAGE FOR THE INTRODUCTION OF THE PROGRAM
...
REDO:		
		CALL 		BDOS 				;FIRST NUMBER OF THE ADDITION DUBTRACTION
		CPI			CR
...
DONE:	
		CALL		SIGN				;AFTET PLUS OR MINUS IS CHOSEN STARTS TO TAKE IN TEH NEXT VALUE ADD/SUB=
